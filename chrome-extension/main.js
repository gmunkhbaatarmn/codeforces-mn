...
$(function() {
  if ($("#header .lang-chooser").length > 0) {
    return $("#header .lang-chooser > div:first").prepend("<a href=\"http://www.codeforces.mn/\"><img src=\"http://www.codeforces.mn/images/flag-mn.png\" title=\"Монголоор\" alt=\"Монголоор\"></a>");
  }
});
